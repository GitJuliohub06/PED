...
void IngresarDatos(struct Peliculas pelis[], int n);
...
void IngresarDatos(struct Peliculas pelis[], int n)
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        std::cin >> pelis[i].titulo_de_la_pelicula;
        std::cout << "Ingrese la duracion de la pelicula en minutos: ";
        std::cin >> pelis[i].duracion_de_la_pelicula_en_minutos;
        std::cout << "Ingrese la calificacion de la pelicula (de 1 a 10): ";
        std::cin >> pelis[i].calificacion_de_la_pelicula;
        std::cout << "Ingrese el genero de la pelicula: ";
        std::cin >> pelis[i].genero_de_la_pelicula;
        std::cout << "------------------------------------------------------" << '\n';
    }
}
...
void MostrarPelicula(struct Peliculas pelis[], int n, struct Promedios promedios)
{
    ...
    for (int i = 0; i < n; i++)
    {
        std::cout << "Titulo de la pelicula: " << pelis[i].titulo_de_la_pelicula << '\n';
        std::cout << "Duracion de la pelicula en minutos: " << pelis[i].duracion_de_la_pelicula_en_minutos << '\n';
        std::cout << "Calificacion de la pelicula: " << pelis[i].calificacion_de_la_pelicula << '\n';
        std::cout << "Genero de la pelicula: " << pelis[i].genero_de_la_pelicula << '\n';
        std::cout << "------------------------------------------------------" << '\n';
    }
...
struct Promedios CalcularPromedio(struct Peliculas pelis[], int n, struct Promedios promedios)
{
    ...
    for (int i = 0; i < n; i++)
    {
        if ((pelis[i].genero_de_la_pelicula == "Drama") || (pelis[i].genero_de_la_pelicula == "drama"))
        {
            promedios.drama += pelis[i].calificacion_de_la_pelicula;
            contador_drama++;
        }
        else if ((pelis[i].genero_de_la_pelicula == "Accion") || (pelis[i].genero_de_la_pelicula == "accion"))
        {

            promedios.accion += pelis[i].calificacion_de_la_pelicula;
            contador_accion++;
        }
        else if ((pelis[i].genero_de_la_pelicula == "Comedia") || (pelis[i].genero_de_la_pelicula == "comedia"))
        {

            promedios.comedia += pelis[i].calificacion_de_la_pelicula;
            contador_comedia++;
        }

        else
        {
            promedios.otros_generos += pelis[i].calificacion_de_la_pelicula;
...
void BuscarPelicula(struct Peliculas pelis[], int n)
{
    ...
    for (int i = 0; i < n; i++)
    {
        if (nombre_de_la_peli == pelis[i].titulo_de_la_pelicula)
        {
            std::cout << "Titulo de la pelicula: " << pelis[i].titulo_de_la_pelicula << '\n';
            std::cout << "Duracion de la pelicula en minutos: " << pelis[i].duracion_de_la_pelicula_en_minutos << '\n';
            std::cout << "Calificacion de la pelicula: " << pelis[i].calificacion_de_la_pelicula << '\n';
