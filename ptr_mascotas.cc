...
void IngresarDatos(struct Mascotas *masc, int cantidad);

void MostrarRegistros(struct Mascotas *masc, int cantidad);

void ModificarEstadoDeVacunacion(struct Mascotas *masc, int cantidad);

void FiltrarMascotasPorEstadoDeVacunacion(struct Mascotas *masc, int cantidad);

void ContarMascotasPorEstadoDeVacunacion(struct Mascotas *masc, int cantidad);

void BuscarMascotasPorNombre(struct Mascotas *masc, int cantidad);
